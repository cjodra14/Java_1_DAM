...
public class CuadradosCirculos extends JPanel { 
	public void paint(Graphics g) {  //si usamos la clase Graphics2D podemos acceder a más métodos que con la clase Graphics	 // para ello creamos una instacia de Graphics2D y hacemos un casting a la instancia g
		Graphics2D g2d= (Graphics2D) g; //necesitamos import java.awt.Graphics2D;                          
		g.setColor(Color.RED);
		g.fillOval(20, 100, 30, 30);
		g.drawOval(20, 50, 30, 30);		
		g.fillRect(150, 100, 30, 30); //para estos métodos se puede usar la instancia g ó g2d
	...
	public static void main(String[] args) { 
		...
		//ventana.add(obj);
            //sustituye a las 2 líneas anteriores
	}
}
